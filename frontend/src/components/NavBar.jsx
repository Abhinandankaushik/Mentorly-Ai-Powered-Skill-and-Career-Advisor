  ...
  return (
    <div className=' h-16 top-0 w-full bg-gray-100 sticky navbar flex justify-between items-center border-b-black'>
      <div className='w-32 h-18 flex justify-around items-center '>
        <img src="../public/weblogo.jpeg" alt="" className='object-cover h-12 w-12'/>
      ...
      <div className='flex justify-around gap-5 content-center'>
        ...
        <NavLink to={"/testimonial"} className={({isActive})=>isActive? "text-orange-500":"text-black"}>Testimonial</NavLink>
        <NavLink to={"/aboutUs"} className={({isActive})=>isActive? "text-orange-500":"text-black"}>About us</NavLink>
      </div>
      <div>
